- 👋 Hi, I’m @AlejandroBlanco2001, a Computer Scientist
- 👀 I’m interested in Web devolopment and IA
- 🌱 I’m currently learning Go, FastAPI and Google ADK
- 💞️ I’m looking to collaborate on any open source project
- 📫 Reach me through alex.zgz@live.com

```javascript
const Alejandro = {
  code: [Javascript, Typescript, HTML, CSS, SASS, Java, Python, SQL, Go],
  tools: [React, Angular, Express, Node, ChakraUI, SocketIO, Vite, Jest, Pandas, ScikitLearn, MongoDB, Django, DRF, G-ADK],
...
| [Google Python ADK](https://github.com/google/adk-python) | [3](https://github.com/google/adk-docs/pull/1697) |
